...
// Truy vấn dữ liệu
$sql    = "SELECT san_pham_id, anh, gia_san_pham_md, ten_san_pham FROM bo_suu_tap_md ORDER BY san_pham_id";
$result = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Bộ Sưu Tập Mùa Đông</title>
...
<body>
    ...
    <!-- Nội dung chính -->
    <main>
        <h1 style="text-align:center; padding-top:20px;">Bộ Sưu Tập Mùa Đông</h1>
            ...
            <?php if ($result && $result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <?php 
                        ...
                        $gia = number_format($row['gia_san_pham_md'], 0, ',', '.');
                    ?>
